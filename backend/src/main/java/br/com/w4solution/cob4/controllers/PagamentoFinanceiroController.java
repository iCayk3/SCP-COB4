...
@RestController @RequestMapping("/api/financeiro/pagamentos") public class PagamentoFinanceiroController{
	...
	@GetMapping @PreAuthorize("isAuthenticated()") public List<PagamentoFinanceiroDTO> listar(@RequestParam String cobrancaReferencia){return service.listar(cobrancaReferencia);}
}
