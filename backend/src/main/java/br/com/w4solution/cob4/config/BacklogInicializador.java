...
public class BacklogInicializador implements ApplicationRunner {
	...
	public void run(ApplicationArguments args) {
		...
		repository.saveAll(List.of(
				...
				i("BL-011", "Promessas de pagamento", BacklogItem.Prioridade.P1, BacklogItem.Status.NAO_INICIADO, 20,
						"Registrar valor, vencimento, situação e vínculo com acordos."),
				i("BL-012", "Descontos por perfil", BacklogItem.Prioridade.P1, BacklogItem.Status.NAO_INICIADO, 30,
						"Limites configurados e exceções passam por aprovação."),
				i("BL-013", "Confirmação financeira", BacklogItem.Prioridade.P1, BacklogItem.Status.NAO_INICIADO, 40,
						"Financeiro confirma baixa RBX ou comprovante informado."),
				i("BL-014", "Fechamento mensal versionado", BacklogItem.Prioridade.P1, BacklogItem.Status.NAO_INICIADO, 50,
						"Fechamento do dia 5 preserva versões, cancelamento e substituição."),
				i("BL-015", "Relatórios PDF e planilha", BacklogItem.Prioridade.P1, BacklogItem.Status.NAO_INICIADO, 60,
