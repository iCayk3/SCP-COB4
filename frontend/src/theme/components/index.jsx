...
import { DatePicker, TimePicker, DateTimePicker, MobileDatePicker, StaticDatePicker, DesktopDatePicker, DesktopTimePicker, DesktopDateTimePicker, DatePickersOutlinedInput } from './pickers';
export const componentsOverride = theme => {
  return {
    MuiCssBaseline: {
      styleOverrides: {
        ...
        body: {
          width: '100%',
          height: '100%',
          '--bprogress-color': theme.palette.primary.main
        },
        a: {
    ...
    MuiPickersOutlinedInput: DatePickersOutlinedInput(theme),
    // INPUT & LABEL
